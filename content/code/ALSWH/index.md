...
| Description | R Code |
| --- | --- |
| 1 - Data extraction - pull relevant variables from each wave | [Data extraction](https://github.com/philipclare/ALSWH/blob/master/Code/2026/1_Data_extraction.R) |
| 2 - Merge data - merge waves and create derived variables | [Merge data](https://github.com/philipclare/ALSWH/blob/master/Code/2026/2_Data_merge.R) |
| 3a - Multiple imputation - impute intermittent missing data | [Imputation](https://github.com/philipclare/ALSWH/blob/master/Code/2026/3a_Multiple_imputation.R) |
| 3b - Multiple imputation for sensitivity analysis | [Imputation](https://github.com/philipclare/ALSWH/blob/master/Code/2026/3b_Multiple_imputation_sensitivity.R) |
| 4 - Final data creation - finalise imputed data and structure for analysis | [Finalise data](https://github.com/philipclare/ALSWH/blob/master/Code/2026/4_Data_finalise.R) |
| 5a - Linearity tests for functional form of PA in primary analysis | [Primary linearity](https://github.com/philipclare/ALSWH/blob/master/Code/2026/5a_Primary_linearity.R) |
| 5b - Linearity tests for functional form of PA in categorical analysis | [Categorical linearity](https://github.com/philipclare/ALSWH/blob/master/Code/2026/5b_Categorical_linearity.R) |
| 5c - Linearity tests for functional form of PA in analysis of 'severe' obesity | [Severe linearity](https://github.com/philipclare/ALSWH/blob/master/Code/2026/5c_Severe_obesity_linearity.R) |
| 5d - Linearity tests for functional form of PA in analysis of five-percent weight gain | [Five-percent linearity](https://github.com/philipclare/ALSWH/blob/master/Code/2026/5d_Five_percent_weight_gain_linearity.R) |
| 5e - Linearity tests for functional form of PA in analysis of ten-percent weight gain | [Ten-percent linearity](https://github.com/philipclare/ALSWH/blob/master/Code/2026/5e_Ten_percent_weight_gain_linearity.R) |
| 5e - Linearity tests for post-hoc analysis of continuous BMI | [BMI linearity](https://github.com/philipclare/ALSWH/blob/master/Code/2026/5f_Post-hoc_bmi_linearity.R) |
| 5g - Combine and summarise linearity tests | [Combine linearity](https://github.com/philipclare/ALSWH/blob/master/Code/2026/5g_Summarise_linearity_results.R) |
| 6a - Primary analysis | [Primary analysis](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6a_Primary_analysis.R) |
| 6b - Categorical analysis | [Categorical analysis](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6b_Categorical_analysis.R) |
| 6c - Analysis of 'severe' obesity | [Severe analysis](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6c_Severe_obesity_outcome_analysis.R) |
| 6d - Analysis of five-percent weight gain | [Five-percent analysis](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6d_Five_percent_weight_gain_analysis.R) |
| 6e - Analysis of ten-percent weight gain | [Ten-percent analysis](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6e_Ten_percent_weight_gain_analysis.R) |
| 6f - Secondary analysis stratified by level of education | [Stratified analysis](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6f_Secondary_analysis_stratified.R) |
| 6g - Sensitivity analysis controlling for descendants of possible unmeasured confounder | [Sensitivity analysis 1](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6g_Sensitivity_analysis_descendent_adjustment.R) |
| 6h - Sensitivity analysis excluding variables that were wholly imputed in some waves | [Sensitivity analysis 2](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6h_Sensitivity_analysis_excluding_imputed.R) |
| 6i - Post-hoc sensitivity analysis of continuous BMI | [Sensitivity analysis 3](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6i_Post-hoc_bmi.R) |
| 6j - Post-hoc analysis using 'natural course' | [Natural course analysis](https://github.com/philipclare/ALSWH/blob/master/Code/2026/6j_Post-hoc_natural_regime.R) |
| 7 - Pool results across imputations and create analysis figures | [Pool results](https://github.com/philipclare/ALSWH/blob/master/Code/2026/7_Pool_results.R) |
| 8 - Create plots to graphically report the analysis findings | [Create plots](https://github.com/philipclare/ALSWH/blob/master/Code/2026/8_Create_plots.R) |
| 9 - Socio-demographic descriptives for Table 1 and on unadjusted incidence of outcomes. | [Sociodemographic descriptives](https://github.com/philipclare/ALSWH/blob/master/Code/2026/9_Descriptive_statistics.R) |
| 10 - E-Value analysis of unmeasured confounding | [EValue analysis](https://github.com/philipclare/ALSWH/blob/master/Code/2026/10_EValue_analysis.R) |
| 11 - Missing data summary for appendix | [Missing data](https://github.com/philipclare/ALSWH/blob/master/Code/2026/11_Missing_data_summary.R) |
